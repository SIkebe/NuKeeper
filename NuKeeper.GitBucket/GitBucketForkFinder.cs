...
{
    public class GitBucketForkFinder : IForkFinder
    {
        private readonly ICollaborationPlatform _collaborationPlatform;
        private readonly INuKeeperLogger _logger;
        private readonly ForkMode _forkMode;

        public GitBucketForkFinder(ICollaborationPlatform collaborationPlatform, INuKeeperLogger logger, ForkMode forkMode)
        {
        ...
        private async Task<bool> IsPushableRepo(ForkData originFork)
        {
            ...
            // GitBucket v4.33.0 doew not return UserPermissions
            return originRepo != null;
        }
    }
}
